 ...
 * Description:       Skeleton for custom WooCommerce payment gateways / orchestrators (Stub by default; optional deletable reference adapters).
 * Version:           1.2.0
...
define( 'WC_GATEWAY_BOILERPLATE_VERSION', '1.2.0' );
