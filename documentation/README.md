...
Public docs for the **WooCommerce Payment Gateway Boilerplate** — a **skeleton** to build custom payment orchestrators/gateways.
...
| [i18n](./i18n.md) | Text domain, translations, locale |

Local Docker setup lives in the root [`DOCKER.md`](../DOCKER.md).  
